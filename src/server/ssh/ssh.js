...
module.exports.connect = async function(serverPort,res) {
      ...
      var config = require('./app')(IP, socketPort).config
      var server = require('./app')(IP, socketPort).server
      ...
      server.on('error', function (err) {
        if (err.code === 'EADDRINUSE') {
          ...
          res.redirect('http://localhsot:' + serverPort + '/home')
        }
      })
