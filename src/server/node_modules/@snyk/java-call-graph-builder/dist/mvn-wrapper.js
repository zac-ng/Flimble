...
function evaluateExpression(projectDirectory, expression) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
function getBuildDir(baseDir) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return yield evaluateExpression(baseDir, 'project.build.directory');
    });
}
exports.getBuildDir = getBuildDir;
function getOutputDir(baseDir) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return yield evaluateExpression(baseDir, 'project.build.outputDirectory');
    });
}
exports.getOutputDir = getOutputDir;
function getDepsClassPath(baseDir) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
function makeMavenModule(baseDir) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const buildDir = yield getBuildDir(baseDir);
        const outputDir = yield getOutputDir(baseDir);
        const depsClassPath = yield metrics_1.timeIt('getMvnClassPath', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield getDepsClassPath(baseDir);
        }));
        return new MavenModule(baseDir, buildDir, outputDir, depsClassPath);
    });
}
exports.makeMavenModule = makeMavenModule;
function makeMavenProject(baseDir) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const modulesXml = yield evaluateExpression(baseDir, 'project.modules');
        const moduleNames = parseModuleNames(modulesXml);
        const modules = [yield makeMavenModule(baseDir)];
