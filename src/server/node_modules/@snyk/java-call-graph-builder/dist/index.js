...
function getCallGraphMvnLegacy(targetPath, timeout) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            const [classPath, targets] = yield Promise.all([
                metrics_1.timeIt('getMvnClassPath', () => mvn_wrapper_legacy_1.getClassPathFromMvn(targetPath)),
...
function getCallGraphMvn(targetPath, timeout) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            const project = yield mvn_wrapper_1.makeMavenProject(targetPath);
