...
export declare function getBuildDir(baseDir: string): Promise<string>;
export declare function getOutputDir(baseDir: string): Promise<string>;
export declare function getDepsClassPath(baseDir: string): Promise<ClassPath>;
...
export declare function makeMavenModule(baseDir: string): Promise<MavenModule>;
export declare function makeMavenProject(baseDir: string): Promise<MavenProject>;
