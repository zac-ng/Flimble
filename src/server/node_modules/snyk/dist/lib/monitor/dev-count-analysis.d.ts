...
export declare function runGitLog(timestampEpochSecondsStartOfPeriod: number, repoPath: string, fnShellout: (cmd: string, workingDirectory: string) => Promise<string>): Promise<string>;
