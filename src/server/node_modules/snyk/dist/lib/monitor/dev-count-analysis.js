...
async function getContributors({ endDate, periodDays, repoPath } = {
    ...
    const gitLogResults = await runGitLog(timestampStartOfContributingDeveloperPeriod, repoPath, execShell);
