...
function applyPatch(patchFileName, vuln, live, patchUrl) {
    ...
    return new Promise((resolve, reject) => {
        ...
        try {
            ...
            const isSemverMatch = semver.satisfies(versionOfPackageToPatch, patchableVersionsRange);
            const isVersionMatch = semver.satisfies(versionOfPackageToPatch, semver.valid(semver.coerce(vuln.patches.version)));
